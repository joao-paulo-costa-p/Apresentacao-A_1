...
const cidadeImaginaria = [-15.7801, -47.9292]; // Latitude e longitude fictícias (Brasília como exemplo)

// Inicializa o mapa e define o ponto central e o nível de zoom
const map = L.map('map').setView(cidadeImaginaria, 13); // 'map' é o ID do elemento HTML onde o mapa será renderizado
...
L.marker(cidadeImaginaria) // Usa as mesmas coordenadas para posicionar o marcador
